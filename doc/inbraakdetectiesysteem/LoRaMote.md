...
- [LoRa Gateway](#lora-gateway)
  ...
  - [Verbinding met het internet](#verbinding-met-het-internet)
      - [Voorts gingen we naar onze favoriete browser, Google Chrome en typten we dat IP-adres in.](#voorts-gingen-we-naar-onze-favoriete-browser-google-chrome-en-typten-we-dat-ip-adres-in)
